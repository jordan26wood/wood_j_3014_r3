...
--
-- Table structure for table `tbl_failed`
--

DROP TABLE IF EXISTS `tbl_failed`;
CREATE TABLE IF NOT EXISTS `tbl_failed` (
  `failed_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `failed_attempts` varchar(10) NOT NULL,
